...
// IKKE fjern __Secure-3PSIDTS fra krukka. Det ble prøvd i 1.3.5 og måtte
// rulles tilbake samme dag. Tanken var at cookien blir foreldet fordi vi
// aldri kaller accounts.google.com/RotateCookies slik en nettleser gjør, og
// at det var derfor to brukere ble logget ut på tredje fornyelse. Men
// cookien er bundet til __Secure-3PSID: en økt som ble opprettet med den,
// krever den, og uten den svarer Google USER_LOGGED_OUT med én gang.
// Verifisert med en fersk innlogging i et vanlig Chrome-vindu. Økter uten
// cookien finnes og lever i ukevis, men det er en egenskap ved økten, ikke
// noe vi kan lage ved å slette en linje.
...
async function fetchAccessToken(issueToken, cookie, { timeoutMs = 15000 } = {}) {
  ...
  // nytt fra DevTools.
  const finalCookie = merged.includes(`${REQUIRED_COOKIE}=`) ? merged : cookie;
